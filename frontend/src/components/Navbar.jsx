...
const Navbar = () => {
  ...
  // Synchronize cart data when a user logs in
  useEffect(() => {
    if (user) {
      getCartItems();
    }
  ...
  // Calculate total item count across cart items
        ...
        <div className="flex flex-wrap justify-between items-center">
          ...
          <nav className="flex flex-wrap items-center gap-4">
            ...
            {isAdmin && (
              <Link
                to="/secret-dashboard"
                className="bg-emerald-700 hover:bg-emerald-600 text-white px-3 py-1 rounded-md font-medium transition duration-300 ease-in-out flex items-center gap-1"
              >
                <Lock size={18} />
